            ...
            React.createElement("nav", null, 
                React.createElement("div", {className: "content"}, 
                    ...
                    React.createElement("ul", {className: "pull-right"}, 
                        React.createElement("a", {href: ""}, React.createElement("i", {className: "fa fa-facebook-square fa-2x"})), 
                        React.createElement("a", {href: ""}, React.createElement("i", {className: "fa fa-envelope-square fa-2x"}))
                    )
                )
            )
        )
